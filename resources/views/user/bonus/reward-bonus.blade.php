<div id="main-content" class="flex-grow-1 m-3">
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm main-header">
        <div class="container-fluid">
            ...
            <span class="navbar-brand text-capitalize text-white mb-0 h1 d-none d-sm-inline-block"> Direct Income</span>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h5 class="mb-1">Direct Income</h5>
