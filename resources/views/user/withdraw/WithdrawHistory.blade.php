            ...
            <button class="btn btn-outline-secondary" type="submit" style="border-left: none;background-color:#0493CA;color:#fff">
                <i class="fas fa-search"></i>
                           ...
                           @forelse($withdraw_report as $withdraw)
						            ...
						            <tr>
                                        <td>Payment Mode: {{ $withdraw->payment_mode }}</td>
                                        <td><b>${{ number_format($withdraw->amount, 2) }}</b></td>
                                        
                                      <td>{{ $withdraw->status }}</td>

                                       <td><a href="" class="themed-link">{{ \Carbon\Carbon::parse($withdraw->created_at)->format('M-d-Y h:i:s A') }}</a></td>
