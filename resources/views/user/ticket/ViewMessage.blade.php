...
<div id="main-content" class="flex-grow-1 m-3">
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm main-header">
        <div class="container-fluid">
            ...
            <span class="navbar-brand text-capitalize text-white mb-0 h1 d-none d-sm-inline-block">Support Message</span>
                    ...
                    <div class="table-responsive">
                     ...
                     <table  id="example" class="table table-bordered table-striped"  >
                                    <?php if(is_array($open_ticket_msg) || is_object($open_ticket_msg)){ ?>
                                            ...
                                            <h5 class="form-header" style="width: 274px; background:#e92266;padding: 7px;color: #fff;border-radius: 10px;margin-left:10px;margin-top:10px"> <?= $item->category ?> (<?=$item->gen_date?>)</h5>
                                            <br>
                                           <p class="comp_bank_p" style="color:#fff;margin-left:10px" ><?= $item->msg ?></p>
