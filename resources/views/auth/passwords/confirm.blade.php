...
<div class="hero">
    <div class="container text-center">
        <h1 style="null">Welcome to <span class="gradient-text">{{siteName()}}</span></h1>
                    ...
                    <div class="card-body p-4">
                        ...
                        function checkform() {
                            ...
                            return true;
                                    ...
                                    <form method="post" action="{{route('verifyCode')}}" name="forgotform" onsubmit="return checkform();" class="forgot-form">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="mb-2">Enter Recovery Code</label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                                <i class="bx bx-envelope"></i>
                                            </span>
                                            <input type="text" name="code" value="" class="form-control" placeholder="Recovery Code" autofocus="autofocus" fdprocessedid="ehwrdw">
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid mt-4">
                                        <button type="submit" class="button" fdprocessedid="vmhkae">Submit</button>
                                    </div>
                                </form>
