...
var contracts = {"60":"0.01","120":"0.013","180":"0.015","Unlimited":"0.02"};
...
function get_lvl(ghs, algorithm) {
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 0 && ghs < 100 ) || ( algorithm == 'SHA-256' && ghs >= 0 && ghs < 10 ) || ( algorithm == 'SCRYPT' && ghs >= 0 && ghs < 20 ) ){
			var lvl = {
			'level': 0,
			'percent': 1
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 100 && ghs < 500 ) || ( algorithm == 'SHA-256' && ghs >= 10 && ghs < 50 ) || ( algorithm == 'SCRYPT' && ghs >= 20 && ghs < 100 ) ){
			var lvl = {
			'level': 1,
			'percent': 1.2
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 500 && ghs < 1000 ) || ( algorithm == 'SHA-256' && ghs >= 50 && ghs < 100 ) || ( algorithm == 'SCRYPT' && ghs >= 100 && ghs < 200 ) ){
			var lvl = {
			'level': 2,
			'percent': 1.5
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 1000 && ghs < 3000 ) || ( algorithm == 'SHA-256' && ghs >= 100 && ghs < 300 ) || ( algorithm == 'SCRYPT' && ghs >= 200 && ghs < 600 ) ){
			var lvl = {
			'level': 3,
			'percent': 2
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 3000 && ghs < 5000 ) || ( algorithm == 'SHA-256' && ghs >= 300 && ghs < 500 ) || ( algorithm == 'SCRYPT' && ghs >= 600 && ghs < 1000 ) ){
			var lvl = {
			'level': 4,
			'percent': 2.2
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 5000 && ghs < 10000 ) || ( algorithm == 'SHA-256' && ghs >= 500 && ghs < 1000 ) || ( algorithm == 'SCRYPT' && ghs >= 1000 && ghs < 2000 ) ){
			var lvl = {
			'level': 5,
			'percent': 2.5
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 10000 && ghs < 20000 ) || ( algorithm == 'SHA-256' && ghs >= 1000 && ghs < 2000 ) || ( algorithm == 'SCRYPT' && ghs >= 2000 && ghs < 4000 ) ){
			var lvl = {
			'level': 6,
			'percent': 3
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 20000 && ghs < 50000 ) || ( algorithm == 'SHA-256' && ghs >= 2000 && ghs < 5000 ) || ( algorithm == 'SCRYPT' && ghs >= 4000 && ghs < 10000 ) ){
			var lvl = {
			'level': 7,
			'percent': 3.5
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 50000 && ghs < 70000 ) || ( algorithm == 'SHA-256' && ghs >= 5000 && ghs < 7000 ) || ( algorithm == 'SCRYPT' && ghs >= 10000 && ghs < 14000 ) ){
			var lvl = {
			'level': 8,
			'percent': 4
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 70000 && ghs < 100000 ) || ( algorithm == 'SHA-256' && ghs >= 7000 && ghs < 10000 ) || ( algorithm == 'SCRYPT' && ghs >= 14000 && ghs < 20000 ) ){
			var lvl = {
			'level': 9,
			'percent': 4.5
			}
		}else
			if ( 1==0 || ( algorithm == 'KHEAVYHASH' && ghs >= 100000 && ghs < 2147483647 ) || ( algorithm == 'SHA-256' && ghs >= 10000 && ghs < 2147483647 ) || ( algorithm == 'SCRYPT' && ghs >= 20000 && ghs < 2147483647 ) ){
			var lvl = {
			'level': 10,
			'percent': 5
			}
